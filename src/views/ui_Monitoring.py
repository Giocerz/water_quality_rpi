...
################################################################################
## Form generated from reading UI file 'MonitoringQloJIw.ui'
##
...
"")
        ...
        self.saveBtn.setGeometry(QRect(340, 220, 131, 41))
        ...
        self.pauseBtn.setGeometry(QRect(60, 220, 131, 41))
        self.pauseBtn.setStyleSheet(u"border-radius: 20px;")
        self.backBtn = QPushButton(self.centralwidget)
        self.backBtn.setObjectName(u"backBtn")
        self.backBtn.setGeometry(QRect(10, 222, 41, 41))
...
"	font-size: 16px;")
        ...
        self.captureBtn.setGeometry(QRect(200, 220, 131, 41))
        ...
        self.captureCountLbl.setGeometry(QRect(300, 210, 37, 37))
